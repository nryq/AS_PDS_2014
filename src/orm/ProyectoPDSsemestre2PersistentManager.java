...
public class ProyectoPDSsemestre2PersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "ProyectoPDSsemestre2";
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new ProyectoPDSsemestre2PersistentManager();
		}
